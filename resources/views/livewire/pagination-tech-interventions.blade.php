    ...
    <table>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ Carbon\Carbon::parse($intervention->dateTimeVisit)->isoFormat('MMM D, YYYY HH[:]mm A') }}
                </td>
                ...
                <td>
                    <div class="table-actions"><a href="{{ route('techinterventions.validate', $intervention->id) }}">
